...
const Header = () => {
  ...
  // Handle external / internal navigation
    ...
    <div className="w-full bg-white md:bg-gradient-to-r md:from-blue-900 md:to-slate-900 relative z-50">
      ...
      {menuOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 z-40 flex">
          <div
            ref={mobileNavRef}
            className="ml-auto w-80 bg-white h-full shadow-lg overflow-y-auto"
          >
                  ...
                  {menuItem.sections?.length > 0 && (
                    <svg
                      className={`w-5 h-5 transition-transform ${
                        expandedMenu === menuItem.label ? "rotate-180" : ""
                      }`}
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                ...
                {menuItem.sections &&
                  ...
                  menuItem.sections.map((section, i) => (
                    <div key={i} className="bg-gray-50 pl-6 pr-4 py-2">
                      <div className="font-semibold text-red-700 text-sm border-b mb-2 pb-1">
                        {section.title}
                      </div>
            ...
            <div className="flex gap-5 p-4 justify-center border-t border-gray-200 mt-4">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-pink-600 hover:text-yellow-500"
              >
                <FaInstagram size={20} />
              </a>
              <a
